...
{$IF Defined(MSWINDOWS)}
  {$IFDEF WIN32}
    ...
    // tried to compile with mingw and visual studio 2015
    // static linking does not work under windows  WRONG COFF Magicn number is the error
  {$ELSE}
...
{$ELSEIF Defined(UNIX)}
  ...
  // this is only valid for linux 32
  //  {$L /home/dinko/projects/PDFPreview/externallibs/i386_linux/libgcc_s-5.3.1-20151207.so.1}
  // {$L g:\dev\mupdf\PDFPreview/externallibs/i386_linux/libgcc_s-5.3.1-20151207.so.1}
  // end of this is only valid for linux 32

  // do not forget to put Project Inspector/ Compiler Options/Path/Libraries
  // Order of libraries is important
  // for Linux 32
  // externallibs\$(TargetCPU)_$(TargetOS);c:\codetyphon\binLibraries\i386-linux\;C:\codetyphon\binLibraries\i386-linux-qt4\
  // for Linux 64
  ...
  {$linklib libjpeg.a}
//  {$linklib libglfw.a}     // this one is not used
  {$linklib libmujs.a}
...
VAR
  ...
  xps_document_handler: fz_document_handler; external muLibName;
  cbz_document_handler: fz_document_handler; external muLibName;
  img_document_handler: fz_document_handler; external muLibName;
  tiff_document_handler: fz_document_handler; external muLibName;
  html_document_handler: fz_document_handler; external muLibName;
  epub_document_handler: fz_document_handler; external muLibName;
...
function fz_new_context_imp(alloc:Pointer; locks: Pointer; max_store: cuint; version: PChar): pfz_context;cdecl;external muLibName;
function fz_new_context(alloc:Pointer; locks: Pointer; max_store: cuint): pfz_context;
procedure fz_new_document_handler_context(ctx: pfz_context);cdecl;external muLibName;
procedure fz_drop_document_handler_context(ctx: pfz_context);cdecl;external muLibName;
...
procedure fz_register_document_handler(ctx: pfz_context; var handler: fz_document_handler);cdecl;external muLibName;
...
procedure fz_drop_context(ctx: pfz_context);cdecl;external muLibName;
procedure fz_drop_context_my(ctx: pfz_context);  // My function
...
procedure fz_rotate(var m: fz_matrix; theta: cfloat);cdecl;external muLibName;
...
procedure fz_pre_scale(var mat: fz_matrix; sx: cfloat; sy: cfloat);cdecl;external muLibName;
...
function fz_lookup_device_colorspace(ctx:pfz_context; name: pchar):pfz_colorspace;cdecl;external muLibName;
...
function fz_pixmap_bbox(ctx:pfz_context; pix:pfz_pixmap):fz_bbox;cdecl;external muLibName;
...
function fz_pixmap_width(ctx:pfz_context; pix: pfz_pixmap):cint;cdecl;external muLibName;
...
function fz_pixmap_height(ctx:pfz_context; pix: pfz_pixmap):cint;cdecl;external muLibName;
...
function fz_new_pixmap(ctx:pfz_context; cs:pfz_colorspace; w,h: cint):pfz_pixmap;cdecl;external muLibName;
...
function fz_new_pixmap_with_bbox(ctx: pfz_context; cs: pfz_colorspace; var bbox: fz_irect):pfz_pixmap;cdecl;external muLibName;
...
function fz_new_pixmap_with_data(ctx:pfz_context; cs:pfz_colorspace; w,h: cint; samples: pointer):pfz_pixmap;cdecl;external muLibName;
...
function fz_new_pixmap_with_bbox_and_data(ctx: pfz_context; cs: pfz_colorspace; var r: fz_irect; samples: pointer):pfz_pixmap;cdecl;external muLibName;
...
function  fz_keep_pixmap(ctx: pfz_context; pix: pfz_pixmap):pfz_pixmap;cdecl;external muLibName;
...
procedure fz_drop_pixmap(ctx: pfz_context; pix: pfz_pixmap);cdecl;external muLibName;
...
function  fz_pixmap_colorspace(ctx: pfz_context; pix: pfz_pixmap):pfz_colorspace;cdecl;external muLibName;
...
function fz_pixmap_components(ctx:pfz_context; pix:pfz_pixmap):cint;cdecl;external muLibName;
...
function fz_pixmap_samples(ctx: pfz_context; pix: pfz_pixmap): pointer;cdecl;external muLibName;
...
procedure fz_clear_pixmap_with_value(ctx:pfz_context; pix: pfz_pixmap; value: cint);cdecl;external muLibName;
...
procedure fz_clear_pixmap(ctx:pfz_context; pix:pfz_pixmap);cdecl;external muLibName;
...
procedure fz_drop_device(ctx: pfz_context; dev: pfz_device);cdecl;external muLibName;
...
function  fz_new_trace_device(ctx:pfz_context):pfz_device;cdecl;external muLibName;
...
function  fz_new_bbox_device(ctx: pfz_context; var rect: fz_rect):pfz_device;cdecl;external muLibName;
...
function fz_new_draw_device(ctx: pfz_context; dest: pfz_pixmap):pfz_device;cdecl;external muLibName;
...
function fz_new_draw_device_with_bbox(ctx: pfz_context; dest: pfz_pixmap; var clip: fz_irect):pfz_device;cdecl;external muLibName;
...
function fz_open_document(ctx: pfz_context; const filename: PChar): pfz_document;cdecl;external muLibName;
...
procedure fz_drop_document(ctx: pfz_context; doc: pfz_document);cdecl;external muLibName;
...
function fz_needs_password(ctx: pfz_context; doc: pfz_document):cint;cdecl;external muLibName;
...
function fz_authenticate_password(ctx: pfz_context; doc: pfz_document; password: PChar):cint;cdecl;external muLibName;
...
function fz_count_pages(ctx: pfz_context; doc: pfz_document):cint;cdecl;external muLibName;
...
function fz_load_page(ctx: pfz_context; doc: pfz_document; number: cint):pfz_page;cdecl;external muLibName;
...
procedure fz_drop_page(ctx: pfz_context; page: pfz_page);cdecl;external muLibName;
...
procedure fz_bound_page(ctx: pfz_context; page: pfz_page; var r: fz_rect);cdecl;external muLibName;
...
procedure fz_run_page(ctx: pfz_context; page: pfz_page; dev: pfz_device; var transform: fz_matrix; cookie: pfz_cookie);cdecl;external muLibName;
...
procedure fz_transform_rect(var rect :  fz_rect; var transform: fz_matrix);cdecl;external muLibName;
...
procedure fz_drop_context_my(ctx: pfz_context);
begin
